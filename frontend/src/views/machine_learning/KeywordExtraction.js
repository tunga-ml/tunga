      ...
      <>
        <div className="card">
          <div className="card-header">
            {translate.translate("machine_learning.keyword_extraction.header")}
          </div>
                  ...
                  <CFormGroup row>
                    ...
                    <CCol xs="12" md="9">
                      <CSelect onChange={this.handleDatasetNameChange} custom name="select" id="select">
                        <option value="0">{translate.translate("machine_learning.keyword_extraction.please_choose")}</option>
